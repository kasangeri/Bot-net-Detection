...
with open("a5.csv", 'w') as csvfile:
    spamwriter = csv.writer(csvfile, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
    header = ['f']*18
    spamwriter.writerow(header)
    benign_dir = "/home/saikirandiddi/Documents/HackathonIITK/Botnet_Detection_Dataset/Botnet/zeus/"
    for file_ in os.listdir(benign_dir):
        packets = rdpcap(benign_dir+file_)
        prev_ts = 0
